<?php
class Smartwave_Mango_Block_Configurableswatches_Catalog_Media_Js_Product extends Mage_ConfigurableSwatches_Block_Catalog_Media_Js_Product {
    public function getProductImageFallbacks($keepFrame = null) {
        /* @var $helper Mage_ConfigurableSwatches_Helper_Mediafallback */
        $helper = Mage::helper('mango/mediafallback');
		...
		$keepFrame = Mage::getStoreConfig("mango_settings/product_view/aspect_ratio",$code);
