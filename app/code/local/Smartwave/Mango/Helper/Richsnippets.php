...
class Smartwave_Mango_Helper_Richsnippets extends Mage_Core_Helper_Abstract
{
	...
	public function isEnabled() {
		return Mage::getStoreConfig('mango_settings/richsnippets/enable');
	}
	...
	public function getPriceProperties($product) {
		...
		$includeTax = Mage::getStoreConfig('mango_settings/richsnippets/price_incl_tax');
