...
class Smartwave_Mango_Model_System_Config_Source_Design_Font_Family_Groupcustomgoogle
{
    public function toOptionArray()
    {
		return array(
			array('value' => 'custom',
				  'label' => Mage::helper('mango')->__('Custom...')),
			array('value' => 'google',
				  'label' => Mage::helper('mango')->__('Google Fonts...')),
            
            array('value' => '"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif',
                  'label' => Mage::helper('mango')->__('"Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif')),
