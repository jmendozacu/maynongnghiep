...
{
    const SZOOM_ENABLE = "zoom/general/enable";
    const SZOOM_USED_ZOOM = "zoom/general/used_zoom";
    const SZOOM_TYPE = "zoom/general/type";
    const SZOOM_SCROLL = "zoom/general/scroll_zoom";
    const SZOOM_ICON = "zoom/general/loading_icon";
    const SZOOM_WIN_WIDTH = "zoom/general/zoom_wind_width";
    const SZOOM_WIN_HEIGHT = "zoom/general/zoom_wind_height";
    
    const SZOOM_LENS_SHAPE = "zoom/general/lens_shape";
    const SZOOM_LENS_SIZE = "zoom/general/lens_size";
    const SZOOM_LENS_BORDER_SIZE = "zoom/general/lens_border_width";
    const SZOOM_LENS_BORDER_COLOR = "zoom/general/lens_border_color";
    const SZOOM_LENS_OPACITY = "zoom/general/lens_opacity";
    const SZOOM_LENS_COLOR = "zoom/general/lens_color";
    
    const SZOOM_TIMES = "zoom/general/zoom_img_times";
    const SZOOM_BORDER_WIDTH = "zoom/general/border_width";
    const SZOOM_BORDER_COLOR = "zoom/general/border_color";
    
    const SZOOM_EASING = "zoom/general/easing";
    const SZOOM_EASING_DURATION = "zoom/general/easing_duration";
    const SZOOM_TINT = "zoom/general/tint";
    const SZOOM_TINT_COLOR = "zoom/general/tint_color";
    const SZOOM_TINT_OPACITY = "zoom/general/tint_opacity";
    
    const SZOOM_GAL_RATE = "zoom/gallery/aspect_ratio";
    const SZOOM_GAL_WIDTH = "zoom/gallery/ga_img_width";
    const SZOOM_GAL_HEIGHT = "zoom/gallery/ga_img_height";
    const SZOOM_GAL_ITEM_NUM = "zoom/gallery/ga_item_num";
    const SZOOM_GAL_ITEM_MARGIN = "zoom/gallery/ga_item_margin";    
    
    const SZOOM_LB_ENABLE = "zoom/lightbox/lb_enable";
    const SZOOM_LB_POSITION = "zoom/lightbox/lb_icon_position";
